...
**Grading: Not afunction, but taking points for that off in q2. 3pts**

4. Within a function list the cities in Florida that have airports in the dataset. (*2 points*)

**Grading: Same as above: 2pts**
...
Using functions correctly | 2 points | **1--did not use functions**
Using comments in code | 2 points | **1pt--no comments, but relatively clear**
